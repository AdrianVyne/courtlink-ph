...
- [x] **Step 3: Implement recursive key redaction and UUID correlation resolution**
...
- [x] **Step 4: Add a JSON Nest logger and Fastify request hooks**
...
- [x] **Step 5: Run focused tests and API typecheck**
...
- [x] **Step 6: Commit the logging slice**
...
- [x] **Step 1: Write failing threshold and readiness tests**
...
- [x] **Step 3: Implement capacity classification and snapshot types**
...
- [x] **Step 4: Implement PostgreSQL, Redis, process, and BullMQ probes**
...
- [x] **Step 5: Split liveness from readiness**
...
- [x] **Step 7: Commit the readiness slice**
...
- [x] **Step 1: Write a failing queue-policy test**
...
- [x] **Step 3: Implement and apply retry retention policy**
...
- [x] **Step 4: Expose sanitized failed jobs through the operations probe**
...
- [x] **Step 5: Run worker and operations tests**
...
- [x] **Step 6: Commit queue reliability**
...
- [x] **Step 3: Add super-admin-only status and metrics endpoints**
...
- [x] **Step 4: Add the admin operations page**
...
- [x] **Step 5: Run API tests, web typecheck, and web build**
...
- [x] **Step 6: Commit operational status**
...
- [x] **Step 1: Document thresholds and non-secret environment settings**
...
- [x] **Step 2: Add alert and incident runbooks**
...
- [x] **Step 3: Add the monthly restore drill runbook**
...
- [x] **Step 4: Record the architecture decision and update plan status**
...
- [x] **Step 5: Run formatting and documentation checks**
...
- [x] **Step 1: Write a live dependency integration test**
...
- [x] **Step 2: Run the integration test against the completed adapter wiring**
...
Expected: PASS with live PostgreSQL, Redis, and all three queue snapshots.

- [x] **Step 3: Complete integration wiring and CI services**
...
- [x] **Step 5: Verify production health and status**
...
- [x] **Step 6: Commit release verification updates**
